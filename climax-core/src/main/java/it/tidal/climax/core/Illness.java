...
public class Illness implements Serializable {
    ...
    public static double computeHumidexValue(double temperature, int humidity) {
        ...
        final int humidex[][] = {
            ...
            {18, 18, 18, 18, 18, 19, 20, 21, 21, 22, 23, 24, 25, 26, 27, 28},
            {19, 19, 19, 19, 20, 21, 21, 22, 22, 23, 24, 25, 26, 27, 28, 29},
            {20, 20, 20, 21, 21, 22, 22, 22, 23, 24, 25, 26, 27, 28, 29, 30},
            {21, 21, 21, 21, 22, 22, 23, 24, 25, 26, 27, 27, 28, 29, 30, 30},
