...
public class ProgramConfig implements Serializable {
    ...
    private Map<WeekDay, Map<String, Map<Hour, GenericDeviceConfig.OperationMode>>> weeklySchedule;
    ...
    public Map<WeekDay, Map<String, Map<Hour, GenericDeviceConfig.OperationMode>>> getWeeklySchedule() {
        return weeklySchedule;
    }

    public void setWeeklySchedule(Map<WeekDay, Map<String, Map<Hour, GenericDeviceConfig.OperationMode>>> weeklySchedule) {
        this.weeklySchedule = weeklySchedule;
    }

    public static ProgramConfig findSuitableConfig(List<ProgramConfig> cfgs) {
