...
import it.tidal.climax.ui.views.dashboard.Dashboard;
...
public class MainLayout extends Div
    ...
    public MainLayout() {
        ...
        dashboard.add(new Icon(VaadinIcon.DASHBOARD), new Text("Dashboard"));
        dashboard.addClassName("main-layout__nav-item");

        Div navigation = new Div(reviews, categories, dashboard);
